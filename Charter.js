...
var Charter = (function() {
	...
	return {
		...
		draw_chart: function(chartID, data, height, width) {
			...
			chart.innerHTML = "<h2 style='text-align:center;margin:5px;font-family:arial;color:"+hcolor+";'>" + name + "</h2><div id='chart_container' height='" + (height-40) +"' width='" + (width-40) + "' style='margin:5px auto;vertical-align:middle;background:" + ccolor + ";border-bottom:2px solid " + border_color + ";border-left:2px solid " + border_color + ";display:inline-block;'></div>";
			//format the styling of the chart main container
			chart.setAttribute("style", "width:" + (width+(20*data.length)) + "px;background-color:" + lcolor + ";display:inline-block;height:"+height+";");
